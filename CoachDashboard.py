...
https://calendly.com/austin-mcnicholas/win-reality-hitting-lesson-clone
        ...
        if st.button("Assessment Email"):
            Assessment = """
Steps For Assessment:

1. Navigate to Main Menu
2. Click on the Workouts Tab
3. Find "14u Assessment"
4. Do the Assessment once

Again thank y'all for doing this, he has access to something that only a handful of our users are able try out. Remember this has to be done 1 day prior to our next session. Try to use the bat attachment if possible.
                        """

            pyperclip.copy(Assessment)
            st.success("Copied Assessment")
